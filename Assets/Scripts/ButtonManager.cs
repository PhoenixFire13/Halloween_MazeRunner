...
public class ButtonManager : MonoBehaviour {
	...
	void Start () {
        ...
        pageText[0] = "\n\n\nControls: \n\nUse the WASD or arroy keys to control the player and navagate the maze\nUse the Q and E key to turn your character";
        pageText[1] = "\n\nHeart Rate: \n\nYour character's heart rate is displayed at the upper left hand corner\nIf your heart rate raises too high, you might die from heart attack\nIf your heart rate drops too low, you might die as well\nYour heart rate will naturally return to a normal level over time";
